...
public class AddClassAcademicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_class_academic);
        ...
        pickDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = new DatePickerDialog(AddClassAcademicActivity.this,
    ...
    public void addClass(View view) {
        ...
        calendarRecord.setEvent_type("Class");
